...
plt.xlabel('Time')
ax1.plot(x, y,'tab:orange', label='Humidity(g/m^3)')
ax2.plot(x, y1,'tab:red', label='Temperature(°C)')
...
axs[0].plot(x,y2, label='CO2(ppm)')
axs[1].plot(x,y,'tab:orange', label='Humidity')
axs[2].plot(x,y1,'tab:red', label='Temperature(°C)')
plt.xlabel('Time')
...
plt.xlabel('Time')
ax1.plot(x, y2, label='CO2(ppm)')
ax2.plot(x, y3,'tab:green', label='TVOC(ppb)')
...
axis[0, 1].plot(x, y3,'tab:green')
axis[0, 1].set_title("TVOC(ppb)")

axis[1, 0].plot(x, y,'tab:orange')
axis[1, 0].set_title("Humidity")

axis[1, 1].plot(x, y1,'tab:red')
